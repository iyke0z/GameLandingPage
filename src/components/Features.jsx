    ...
    <section className='bg-black pb-52'>
      <div className='container mx-auto px-3 md:px-10'>
        ...
        <p className='max-w-md font-circular-web tex-lg text-blue-50 opacity-50'>
            Immerse yourself in a rich and ever-expending universe where a vibrant array of products converge into an interconnected overlay expeirence on your world.
        </p>
      </div>
      </div>
      ...
      <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
        ...
        <BentoTilt className='bento-tilt_2'>
           <div className='flex size-full flex-col justify-between bg-violet-300 p-5'>
                ...
                <TiLocationArrow className='md-5 scale-[5] self-end' />
           </div>
        </BentoTilt>
